...
def main():
    ...
    app.chat_history.add_source("clipboard", "clipboard")
    app.chat_history.add_source("file", "/tmp/file-1.txt")
#    app.chat_history.add_source("clipboard", "clipboard")
#    app.chat_history.add_source("file", "/tmp/file-2.txt")
#    app.chat_history.add_source("clipboard", "clipboard")
#    app.chat_history.add_source("file", "/tmp/file-3.txt")
#    app.chat_history.add_source("clipboard", "clipboard")
#    app.chat_history.add_source("file", "/tmp/file-4.txt")
